/*install firebase as using the command
* 
  npm i firebase@9.6.1
  yarn add firebase@9.6.1
*
* Ref Link: https://firebase.google.com/docs/web/modular-upgrade#get_the_version_9_sdk
*by Pramod
*WHJR
